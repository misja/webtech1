...
!!! Info "Downloaden van html-bestanden"
    Als je op een van de html-bestanden klikt, wordt deze geopend in je browser. Je ziet bij het eerste bestand waarschijnlijk alleen een pagina met wat tekst. Dit is correct.

    Om de html-bestanden te downloaden, klik op het bestand en gebruik ctrl+s op de nieuw geopende pagina. Nu kan het html-bestand lokaal opgeslagen worden. Alternatief: rechts-klik op het bestand en kies 'Link opslaan als...' (o.i.d.)
